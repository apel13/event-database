...
void TestDatabaseFind() {
    {
        const vector<Database::retType> expected = {
            {{2017, 11, 17}, "Friday"},
            {{2017, 11, 18}, "Saturday"},
            {{2017, 11, 19}, "Sunday"}
        };
    ...
    }
    {
        ...
        const vector<Database::retType> expected = { {{2014, 11, 17}, "Monday"}, {{2016, 11, 17}, "Thursday"} };
    ...
    }
    {
        ...
        AssertEqual(db.FindIf(acceptsNothing), vector<Database::retType>(), "Database find: accepts nothing");
    }
}
...
void TestDatabaseRemove() {
    {
        ...
        AssertEqual(db.FindIf(alwaysTrue), vector<Database::retType>(), "Database remove: alwaysTrue removes all 2");
    }
    {
        Database db;
        db.Add({ 2017, 11, 17 }, "Friday");
        ...
        AssertEqual(db.FindIf(complexCondition), vector<Database::retType>(), "Database remove: complex condition 2");
    }
    {
...
void TestDatabaseLast() {
    {
        ...
        AssertEqual(db.Last({ 2017, 11, 17 }), Database::retType{ {2017, 11, 17}, "One more event" }, "Database last: successful 1");
        AssertEqual(db.Last({ 2017, 11, 16 }), Database::retType{ {2016, 11, 17}, "Thursday" }, "Database last: successful 2");
        AssertEqual(db.Last({ 2016, 11, 17 }), Database::retType{ {2016, 11, 17}, "Thursday" }, "Database last: successful 3");
        AssertEqual(db.Last({ 2016, 11, 18 }), Database::retType{ {2016, 11, 17}, "Thursday" }, "Database last: successful 4");
        AssertEqual(db.Last({ 2014, 11, 18 }), Database::retType{ {2014, 11, 17}, "Monday" }, "Database last: successful 5");
        AssertEqual(db.Last({ 2014, 11, 17 }), Database::retType{ {2014, 11, 17}, "Monday" }, "Database last: successful 6");
    ...
    }
    {
        ...
        db.Add({ 2017, 11, 17 }, "One more event");
        db.Add({ 2017, 11, 17 }, "Friday");
        AssertEqual(db.Last({ 2017, 11, 17 }), Database::retType{ {2017, 11, 17}, "Friday" }, "Database last and remove 1");
        db.RemoveIf([](const Date&, const string& event) { return event == "Friday"; });
        AssertEqual(db.Last({ 2017, 11, 17 }), Database::retType{ {2017, 11, 17}, "One more event" }, "Database last and remove 2");
    }
    {
        Database db;
        db.Add({ 2017, 11, 17 }, "One more event");
        ...
        AssertEqual(db.Last({ 2017, 11, 17 }), Database::retType{ {2016, 11, 17}, "Thursday" }, "Database last and remove 2");
    }
}
